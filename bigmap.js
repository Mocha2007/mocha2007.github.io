					...
					for (property in x.features){
						if (x.features.hasOwnProperty(property)){ // just in case
							if (commonf.hasOwnProperty(property)){
								...
								commonf[property] = x.features[property];
							}
						}
					}
				}
...
var lang = [
	...
	},
	{
		...
		families: ["indo-european", "germanic"],
		areas: ["west europe", "nordic"],
		consonants: "m n N p t k b d g v r j h f s s\\ x\\ l",
		monophthongs: "I i: Y y: }: U u: E e: E: 9 2: 8 o: O a A:",
		diphthongs: "",
		features: {
			adpositions: "prepositions",
			an: "an",
		...
		source: "https://en.wikipedia.org/wiki/Swedish_language"
	},
	{
		name: "Tagalog",
		coords: [15, 121],
...
var implications = [
	...
	[
		"east europe", // east of finland, germany, austria, italy
		["europe"]
	],
	[
		"west europe",
