...
const STATES = [
	...
	['FL', 30, new Polling(0.462, 0.367, 0.03), 22610726, 0.005], // 538
	['GA', 16, new Polling(0.444, 0.384, 0.03), 11029227, 0], // 538
	...
	['NV', 6, new Polling(0.43, 0.36, 0.03), 3194176, 0], // 538
	['NY', 28, new Polling(0.37, 0.508), 19571216, 0], // rttwh
	['OH', 17, new Polling(0.453, 0.357, 0.02), 11785935, 0.0025], // 538
	['OK', 7, new Polling(0.577, 0.326), 4053824, 0], // rttwh
	['OR', 8, new Polling(0.40, 0.52), 4233358, 0.002], // rttwh
	['PA', 19, new Polling(0.429, 0.41, 0.02), 12961683, 0.005], // 538
	...
	['WI', 10, new Polling(0.418, 0.405, 0.02), 5910955, 0], // 538
