...
const UNITS = {
	...
	derived: [
		...
		new Derived('muon mass', 'm<sub>μ</sub>', {mass:1}, 1.883531627e-28),
		new Derived('tau mass', 'm<sub>τ</sub>', {mass:1}, 3.16754e-27),
		...
		new Derived('J/(kg⋅K)', 'specific heat capacity', {length:2,time:-2,temperature:-1}),
		...
		new Derived('N/m', 'surface tension', {mass:1,time:-2}),
		...
		new Derived('W/(m⋅K)', 'thermal conductivity', {mass:1,length:1,time:-3,temperature:-1}),
	],
	elem: {
