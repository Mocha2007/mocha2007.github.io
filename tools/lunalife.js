...
const LUNALIFE = {
	...
	EVENTS: [
		...
		new LunaEvent(new Date(2007, 0), '(appx) dog died ;-;'),
		...
		new LunaEvent(new Date(2008, 11, 25), 'About the time I got Spore (maybe as a christmas gift?). I was obsessed with this game for years.'),
		new LunaEvent(new Date(2009, 2, 22), 'Played Pokemon Platinum, the only Pokemon game I spent a lot of time on.'),
		new LunaEvent(new Date(2009, 8, 7), 'First hints of dysphoria'),
		...
		new LunaEvent(new Date(2010, 11, 25), 'I got Civ5 for christmas and LOVED it, and only stopped playing once EU4 came out 3 years later.'),
		...
		new LunaEvent(new Date(2011, 8, 15), 'I started playing Minecraft in B1.8.1'),
		...
		new LunaEvent(new Date(2013, 3), '(appx) Met the one who would eventually be my BF'),
		...
		new LunaEvent(new Date(2013, 8, 2), '(appx) About the time I started consistently getting gender envy'),
		...
		new LunaEvent(new Date(2020, 2, 3), 'Almost died from Ehrlichia (and my bastard prof wouldn\'t let me redo my midterm...)'),
		new LunaEvent(new Date(2020, 5), 'Tried on women\'s clothing for the first time... and liked it OwO', 'it was after 4/1 before 8/1...'),
		new LunaEvent(new Date(2020, 10, 11), '(appx) Discovered TFGames :^)'),
		...
		new LunaEvent(new Date(2022, 6, 15), 'Came out to BF'),
		new LunaEvent(new Date(2022, 9, 25), 'Discovered and binge-read Rain'),
		new LunaEvent(new Date(2023, 0), 'Came out to friends'),
		new LunaEvent(new Date(2023, 5, 14), 'Move in with BF'),
		...
		new LunaEvent(new Date(2023, 11, 16), 'Met BF\'s family'),
