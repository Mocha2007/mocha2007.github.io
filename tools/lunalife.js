...
const LUNALIFE = {
	CONFIG: {
		LIFESPAN: 89.8, // median of tests (updated 2026-06-23)
		/**
		 ...
		 * 	84		https://www.annuity.org/retirement/planning/life-expectancy/calculator/
		 * 	85.6	https://www.ssa.gov/cgi-bin/longevity.cgi
		 * 	94		https://media.nmfn.com/tnetwork/lifespan/index.html#13
		 * 	97		https://www.johnhancock.com/life-insurance/life-expectancy-calculator.html
		 * 	102.3	https://calcuworld.com/health-calculators/life-expectancy-calculator/
		 */
		get DIM(){
	...
	EVENTS: [
		...
		new LunaEvent(new Date(2004, 8, 7), 'I start elementary school.'),
		new LunaEvent(new Date(2004, 10, 9), 'I remember buying a copy of CotN (I think it was left discarded on a pallet at Costco) and loving it.'),
		new LunaEvent(new Date(2006, 0, 1), '(appx) switch schools.'),
		...
		new LunaEvent(new Date(2008, 7, 10), 'Got to see the premiere of Star Wars: The Clone Wars.'),
		new LunaEvent(new Date(2009, 2, 22), 'Played Pokemon Platinum, the only Pokemon game I spent a lot of time on.'),
		new LunaEvent(new Date(2009, 8, 8), 'I start middle school.'),
		...
		new LunaEvent(new Date(2011, 4, 13), 'Apparently, I created an alt account on gmail and forgot about it for 15 years.'),
		...
		new LunaEvent(new Date(2014, 0, 11), 'Joined Newgrounds.'),
		...
		new LunaEvent(new Date(2018, 2, 30), 'Irikad incident'),
		...
		new LunaEvent(new Date(2020, 7, 9), 'Experienced North Carolina\'s largest earthquake in over a century.'),
		...
		new LunaEvent(new Date(2023, 7, 28), 'Shooting at my workplace'),
		...
		new LunaEvent(new Date(2024, 7, 12), '(appx) Went to Liberec, Czech Republic to obtain E'),
		...
		new LunaEvent(new Date(2025, 2, 29), 'Observed a partial solar eclipse via pinhole.'),
		...
		new LunaEvent(new Date(2026, 4, 25), 'Move to Nowa Sól'),
		new LunaEvent(new Date(2026, 5, 12), 'Began watching the 2026 World Cup (South Korea vs. Czech Republic)'),
		new LunaEvent(new Date(2026, 5, 20), 'Enjoyed the finale of The Amazing Digital Circus'),
		new LunaEvent(new Date(2026, 5, 20), 'Rediscovered an alt account on gmail I made 15 years ago, seemingly for nothing, through an inactive account deletion warning.'),
		new LunaEvent(new Date(2026, 7, 12), 'I viewed a solar eclipse (partial, via eclipse glasses, my fourth).'),
		new LunaEvent(new Date(2026, 7, 16), 'Theoretically the effects of HRT should be largely complete by now.'),
		new LunaEvent(new Date(2026, 7, 28), 'I viewed the beginning of a lunar eclipse (my third), but got clouded out by 4:40 AM.'),
		new LunaEvent(new Date(2026, 7, 31), 'I get my Polish visa stamp.'),
		new LunaEvent(new Date(2027, 7, 2), 'I will attempt to view a solar eclipse (my fifth).'),
		new LunaEvent(new Date(2028, 7, 16), 'Theoretically the effects of HRT should be totally complete by now.'),
		new LunaEvent(new Date(2029, 5, 12), 'I will attempt to view a solar eclipse (my sixth).'),
		new LunaEvent(new Date(2029, 6), 'If I still reside in Poland by this date, and speak Polish fluently, I could apply for citizenship.'),
	...
	ZONES: [
		...
		new LunaEvent(new Date(2017, 4), 'College', '#c0c'), // 15-17
