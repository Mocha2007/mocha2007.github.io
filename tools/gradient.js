...
const GRADIENT = {
	...
	gradientData: {
		...
		open_topo_map: {
			r: [77, 1541.5, -4243.5, 2880],
			g: [168, 663, -2965.5, 2389.5],
			b: [66, 702, -2578.5, 2065.5],
		},
		// luna-made <3
		elevation: {
			r: [81, 366, -132, -70],
		...
		// with additional black and white points
		gameboy3: {
			r: [0, 586, -3336, 9099, -10651, 4557],
			g: [0, 859, -4646, 12635, -15104, 6510],
			b: [0, 830, -5013, 15167, -20625, 9896],
		},
	},
};