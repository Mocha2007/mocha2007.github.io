...
const OOM = {
	...
	data: [
		...
		new MassDatum("Dime (US)", 2.268e-6),
		new MassDatum("Penny (US)", 2.5e-6, "https://hypertextbook.com/facts/2002/MillicentOkereke.shtml"),
		new MassDatum("Nickel (US)", 5e-6),
		new MassDatum("Ducat", 3.5e-6),
		new MassDatum("Quarter (US)", 5.67e-6),
		...
		new MassDatum("Annual global coal production (2019)", 7921e3*1e3, "https://en.wikipedia.org/wiki/Coal_mining#Production"),
		...
		new MassDatum("Annual global iron ore production (2015)", 2280000000*1e3, "https://en.wikipedia.org/wiki/Iron_ore#Production_and_consumption"),
