...
const OOM = {
	...
	dataAngle: [
		...
		new AngleDatum("Ceres", CONSTANT.angular_diameter_heliocentric_orbit(469.7e3, 2.55, 2.98), null, [Category.MINORPLANET]),
		new AngleDatum("Jupiter", CONSTANT.angular_diameter_heliocentric_orbit(69886e3, 4.9506, 5.4570)),
		new AngleDatum("Saturn", CONSTANT.angular_diameter_heliocentric_orbit(58232e3, 9.0412, 10.1238)),
