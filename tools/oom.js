...
class Acceleration extends Dimension {
	constructor(x, uncertainty){
		super("m/s²", 0, CONSTANT.planck_reduced/Math.pow(CONSTANT.c, 3), x, uncertainty);
	}
}
...
class AccelerationDatum extends Datum {
	/**
	 * @param {string} name
	 * @param {number|Acceleration} amt
	 * @param {string?} source
	 * @param {Category[]?} categories
	 */
	constructor(name, amt, source, categories){
		super(Acceleration, name, amt, source, categories);
	}
}
...
const CONSTANT = {
	...
	si_prefix_offset: 10,
	snellen(w, d=6){
		return 2*Math.atan2(8.73e-3*w, d);
	},
	/** in W */
...
const OOM = {
	...
	data: [
		...
		new MassDatum("Positronium", 1.022*CONSTANT.MeVc2, "https://en.wikipedia.org/wiki/Positronium"),
		new MassDatum("Up quark", new Mass({x:2.2*CONSTANT.MeVc2,min:1.8*CONSTANT.MeVc2,max:2.7*CONSTANT.MeVc2}), "https://en.wikipedia.org/wiki/Up_quark"),
		new MassDatum("Down quark", new Mass({x:4.7*CONSTANT.MeVc2,min:4.4*CONSTANT.MeVc2,max:5.2*CONSTANT.MeVc2}), "https://en.wikipedia.org/wiki/Down_quark"),
		new MassDatum("Strange quark", new Mass({x:95*CONSTANT.MeVc2,min:92*CONSTANT.MeVc2,max:104*CONSTANT.MeVc2}), "https://en.wikipedia.org/wiki/Strange_quark"),
		new MassDatum("Muon", 1.883531627e-28, "https://physics.nist.gov/cgi-bin/cuu/Value?mmu"),
		new MassDatum("Pion", new Mass({min:134.9768*CONSTANT.MeVc2,max:139.57039*CONSTANT.MeVc2}), "https://en.wikipedia.org/wiki/Pion"),
		new MassDatum("Kaon", new Mass({min:493.677*CONSTANT.MeVc2,max:497.611*CONSTANT.MeVc2}), "https://en.wikipedia.org/wiki/Kaon"),
		new MassDatum("Eta meson", new Mass(547.862*CONSTANT.MeVc2,0.018*CONSTANT.MeVc2), "https://en.wikipedia.org/wiki/Eta_and_eta_prime_mesons"),
		new MassDatum("Rho meson", 770*CONSTANT.MeVc2, "https://en.wikipedia.org/wiki/Rho_meson"),
		...
		new MassDatum("Charm quark", new Mass(1.27e3*CONSTANT.MeVc2,20*CONSTANT.MeVc2), "https://en.wikipedia.org/wiki/Charm_quark"),
		new MassDatum("Tauon", 3.16754e-27, "https://physics.nist.gov/cgi-bin/cuu/Value?mtau"),
		new MassDatum("Bottom quark", 4.18e3*CONSTANT.MeVc2, "https://en.wikipedia.org/wiki/Bottom_quark"),
		// new MassDatum("Bottom eta meson", 9388.9*CONSTANT.MeVc2),
		// new MassDatum("Upsilon Boson", 9460.30*CONSTANT.MeVc2),
		new MassDatum("W Boson", new Mass(80.3692e3*CONSTANT.MeVc2, 13.3*CONSTANT.MeVc2), "https://en.wikipedia.org/wiki/W_and_Z_bosons"),
		new MassDatum("Z Boson", new Mass(91.1880e3*CONSTANT.MeVc2, 2*CONSTANT.MeVc2), "https://en.wikipedia.org/wiki/W_and_Z_bosons"),
		...
		new MassDatum("Top quark", new Mass(172.76e3*CONSTANT.MeVc2, 300*CONSTANT.MeVc2), "https://en.wikipedia.org/wiki/Top_quark"),
		new MassDatum("WIMP", 1e6*CONSTANT.MeVc2, "https://upload.wikimedia.org/wikipedia/commons/f/f9/Dark_matter_candidates.pdf", [Category.HYPOTHETICAL]),
		// Atoms
		...
		new MassDatum("Tritium atom", 3.01604928*CONSTANT.da, "https://en.wikipedia.org/wiki/Tritium"),
		...
		new MassDatum("Oganesson-294 atom", 294.21398*CONSTANT.da, "https://en.wikipedia.org/wiki/Isotopes_of_oganesson"),
		// Molecules
		new MassDatum("Water", 18.01528*CONSTANT.da, "https://en.wikipedia.org/wiki/Properties_of_water"),
		new MassDatum("Ethanol", 46.069*CONSTANT.da, "https://en.wikipedia.org/wiki/Ethanol"),
		new MassDatum("Glycine", 75.06714*CONSTANT.da, "https://en.wikipedia.org/wiki/Glycine"),
		...
		new MassDatum("FSH", 35.5e3*CONSTANT.da, "https://en.wikipedia.org/wiki/Follicle-stimulating_hormone#Structure"),
		new MassDatum("Lectin", 71e3*CONSTANT.da, "https://bionumbers.hms.harvard.edu/bionumber.aspx?id=104340&ver=2&trm=mass&org="),
		new MassDatum("tRNA", new Mass({min:76*CONSTANT.bp_rna,max:90*CONSTANT.bp_rna}), "https://en.wikipedia.org/wiki/Transfer_RNA"),
		...
		new MassDatum("Mitochondrion genome (human)", 16569 * CONSTANT.bp_dna, "https://en.wikipedia.org/wiki/Mitochondrial_DNA"),
		new MassDatum("Chloroplast genome", 105e6*CONSTANT.da, "https://en.wikipedia.org/wiki/Chloroplast#Molecular_structure"),
		new MassDatum("Pelagibacter communis genome", 1308759 * CONSTANT.bp_dna, "https://en.wikipedia.org/wiki/Pelagibacter_communis#Genome"),
		...
		new MassDatum("South Boösaule Mons (estimate)", CONSTANT.mountain(17.5e3, Math.sqrt(145e3*159e3)/2), "https://en.wikipedia.org/wiki/Boösaule_Montes"),
		new MassDatum("Mauna Kea (estimate)", CONSTANT.mountain(9e3, 120e3), "https://en.wikipedia.org/wiki/Mauna_Kea"),
		new MassDatum("Maat Mons (estimate)", CONSTANT.mountain(4.9e3, 395e3/2), "https://en.wikipedia.org/wiki/Maat_Mons"),
		...
		new MassDatum("15 Eunomia", new Mass(30.5e18, 1.9e18), "https://en.wikipedia.org/wiki/15_Eunomia", [Category.MINORPLANET]),
		new MassDatum("10 Hygiea", new Mass(8.74e19, 0.69e19), "https://en.wikipedia.org/wiki/10_Hygiea", [Category.MINORPLANET]),
		new MassDatum("4 Vesta", new Mass(2.590271e20, 0.000058e20), "https://en.wikipedia.org/wiki/4_Vesta", [Category.MINORPLANET]),
		new MassDatum("3 Juno", new Mass(27e18, 0.24e19), "https://en.wikipedia.org/wiki/3_Juno", [Category.MINORPLANET]),
	...
	dataAngle: [
		...
		new AngleDatum("Achernar A", CONSTANT.angular_diameter(7.97*CONSTANT.solar_radius, 139*CONSTANT.ly), "https://en.wikipedia.org/wiki/Achernar"),
		// new AngleDatum("Alpha Centauri A", CONSTANT.angular_diameter(0.8591*CONSTANT.solar_radius, 4.344*CONSTANT.ly), "https://en.wikipedia.org/wiki/Alpha_Centauri"),
		new AngleDatum("Arcturus", CONSTANT.angular_diameter(25.4*CONSTANT.solar_radius, 36.7*CONSTANT.ly), "https://en.wikipedia.org/wiki/Arcturus"),
		new AngleDatum("Betelgeuse", CONSTANT.angular_diameter(702*CONSTANT.solar_radius, 478*CONSTANT.ly), "https://en.wikipedia.org/wiki/Betelgeuse"),
		new AngleDatum("Canopus", CONSTANT.angular_diameter(73.3*CONSTANT.solar_radius, 310*CONSTANT.ly), "https://en.wikipedia.org/wiki/Canopus"),
		new AngleDatum("Capella Aa", CONSTANT.angular_diameter(11.98*CONSTANT.solar_radius, 42.919*CONSTANT.ly), "https://en.wikipedia.org/wiki/Capella"),
		...
		new AngleDatum("Sun", CONSTANT.angular_diameter_geocentric_orbit(CONSTANT.solar_radius, 147098450e3, 152097597e3), "https://en.wikipedia.org/wiki/Sun"),
		new AngleDatum("Moon", CONSTANT.angular_diameter_geocentric_orbit(1737.4e3, 362600e3, 405400e3), "https://en.wikipedia.org/wiki/Moon"),
		new AngleDatum("Earth (From Moon)", CONSTANT.angular_diameter_geocentric_orbit(CONSTANT.earth_radius, 362600e3, 405400e3, 1737.4e3), "https://en.wikipedia.org/wiki/Earth"),
		new AngleDatum("Earth (From Mars)", CONSTANT.angular_diameter_heliocentric_orbit(CONSTANT.earth_radius, 0.9832924045756489, 1.0167096382341758, 1.3814, 1.66621), "https://en.wikipedia.org/wiki/Earth"),
		new AngleDatum("Mercury", CONSTANT.angular_diameter_heliocentric_orbit(2439.7e3, 0.307499, 0.466697), "https://en.wikipedia.org/wiki/Mercury"),
		new AngleDatum("Venus", CONSTANT.angular_diameter_heliocentric_orbit(6051.8e3, 0.718440, 0.728213), "https://en.wikipedia.org/wiki/Venus"),
		new AngleDatum("Mars", CONSTANT.angular_diameter_heliocentric_orbit(3389.5e3, 1.3814, 1.66621), "https://en.wikipedia.org/wiki/Mars"),
		new AngleDatum("Ceres", CONSTANT.angular_diameter_heliocentric_orbit(469.7e3, 2.55, 2.98), "https://en.wikipedia.org/wiki/Ceres", [Category.MINORPLANET]),
		new AngleDatum("Jupiter", CONSTANT.angular_diameter_heliocentric_orbit(69886e3, 4.9506, 5.4570), "https://en.wikipedia.org/wiki/Jupiter"),
		new AngleDatum("Saturn", CONSTANT.angular_diameter_heliocentric_orbit(58232e3, 9.0412, 10.1238), "https://en.wikipedia.org/wiki/Saturn"),
		...
		new AngleDatum("JWST resolution", CONSTANT.angular_resolution(6.5, 600e-9), "https://en.wikipedia.org/wiki/James_Webb_Space_Telescope"),
		new AngleDatum("HST resolution", CONSTANT.angular_resolution(2.4), "https://en.wikipedia.org/wiki/Hubble_Space_Telescope"),
		new AngleDatum("IRAS resolution (12 μm)", CONSTANT.angular_resolution(0.57, 12e-6), "https://en.wikipedia.org/wiki/IRAS"),
		new AngleDatum("IRAS resolution (100 μm)", CONSTANT.angular_resolution(0.57, 100e-6), "https://en.wikipedia.org/wiki/IRAS"),
		new AngleDatum("Arecibo resolution (3 cm)", CONSTANT.angular_resolution(304.8, 0.03), "https://en.wikipedia.org/wiki/Arecibo_Telescope"),
		new AngleDatum("Arecibo resolution (1 m)", CONSTANT.angular_resolution(304.8, 1), "https://en.wikipedia.org/wiki/Arecibo_Telescope"),
		new AngleDatum("Tianyan resolution (10 cm)", CONSTANT.angular_resolution(500, 0.1), "https://en.wikipedia.org/wiki/Five-hundred-meter_Aperture_Spherical_Telescope"),
		new AngleDatum("Tianyan resolution (4.3 m)", CONSTANT.angular_resolution(500, 4.3), "https://en.wikipedia.org/wiki/Five-hundred-meter_Aperture_Spherical_Telescope"),
	...
	dataLength: [
		...
		new LengthDatum("Poppyseed (unit)", CONSTANT.ft/180, null, [Category.UNIT]),
		new LengthDatum("Line (unit)", CONSTANT.ft/144, null, [Category.UNIT]),
		new LengthDatum("Pica", CONSTANT.ft/72, null, [Category.UNIT]),
		new LengthDatum("Barleycorn", CONSTANT.ft/36, null, [Category.UNIT]),
		new LengthDatum("Digit (unit)", CONSTANT.ft/16, null, [Category.UNIT]),
		new LengthDatum("Finger (unit)", CONSTANT.ft/12*7/8, null, [Category.UNIT]),
		new LengthDatum("Inch", CONSTANT.ft/12, null, [Category.UNIT]),
		new LengthDatum("Nail (unit)", CONSTANT.ft*3/16, null, [Category.UNIT], "https://en.wikipedia.org/wiki/Nail_(unit)"),
		new LengthDatum("Palm (unit)", CONSTANT.ft/4, null, [Category.UNIT]),
		new LengthDatum("Hand (unit)", CONSTANT.ft/3, null, [Category.UNIT]),
		new LengthDatum("Shaftment", CONSTANT.ft/2, null, [Category.UNIT]),
		new LengthDatum("Link (unit)", CONSTANT.ft*33/50, null, [Category.UNIT]),
		new LengthDatum("Span (unit)", CONSTANT.ft*9/12, null, [Category.UNIT]),
		new LengthDatum("Foot (unit)", CONSTANT.ft, null, [Category.UNIT]),
		new LengthDatum("Cubit", CONSTANT.ft*1.5, null, [Category.UNIT]),
		new LengthDatum("Yard (unit)", CONSTANT.ft*3, null, [Category.UNIT]),
		new LengthDatum("Ell", CONSTANT.ft*3.45, null, [Category.UNIT]),
	...
	dataMoney: [
		...
		new MoneyDatum('Costco Hot Dog (US, 1984-2026)', 1.5*CONSTANT.sales_tax.median, "https://en.wikipedia.org/wiki/Costco_hot_dog"),
		...
		new MoneyDatum('iPhone 17 (US, 2026)', 799*CONSTANT.sales_tax.median, "https://www.apple.com/iphone-17/"),
		...
		new MoneyDatum('Proposed US Military Budget (2027)', 1.5e12, "https://preview.redd.it/6on7m0v05zsg1.jpg?width=1320&format=pjpg&auto=webp&s=ed60364a061d7e9ff71d873def3872b70624c99d"),
	...
	dataPower: [
		// abs magnitude units
		new PowerDatum("Absolute Magnitude +10", 0.8550667e-2*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		new PowerDatum("Absolute Magnitude +5", 0.8550667*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		new PowerDatum("Absolute Magnitude 0", 85.50667*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		new PowerDatum("Absolute Magnitude -5", 8550.667*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		new PowerDatum("Absolute Magnitude -10", 855066.7*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		new PowerDatum("Absolute Magnitude -15", 8550667e1*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		new PowerDatum("Absolute Magnitude -20", 8550667e3*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		new PowerDatum("Absolute Magnitude -25", 8550667e5*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		new PowerDatum("Absolute Magnitude -30", 8550667e7*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		new PowerDatum("Absolute Magnitude -35", 8550667e9*CONSTANT.solar_luminosity, "https://en.wikipedia.org/wiki/Absolute_magnitude"),
		// stars/astronomy
	...
	dataSHC: [
		...
		new SHCDatum('Polystyrene', 1300, "https://en.wikipedia.org/wiki/Polystyrene#Forms_produced"),
	...
	dataTemperature: [
		...
		new TemperatureDatum("Planck Temperature", 1.416784e32, "https://en.wikipedia.org/wiki/Planck_units", [Category.UNIT]),
		// misc
