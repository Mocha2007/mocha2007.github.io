...
const EG2 = {
	...
	lexicon: [
		...
		new Word('F', null, null, ['♀'], 'only used to disambiguate referent'),
		...
		new Word('M', null, null, ['♂'], 'only used to disambiguate referent'),
		new Word('NEG', null, null, ['¬']),
		...
		new Word('man', '☺︎', ['♂']),
		new Word('Mars', '♂', ['🪐']),
		new Word('maybe', '%', ['🎲'], null, 'perhaps/possibly, +AUG = probably'),
		new Word('mist', '=', ['☁︎']),
		new Word('month', '🝱'),
		...
		new Word('tie', '🪢', null, null, null, 'bind'),
		new Word('time', '⌛'),
	...
	samples: [
		...
		new Sample("This mist will probably clear away", "mist.this go.from.FUT maybe.AUG.ADV"),
