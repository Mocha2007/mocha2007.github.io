...
const isotopeData = [
	...
	},
	{
		...
		decayTypes: [
			['a', 1],
			['sf', 3e-12],
			// technically two types, listing more common type
			['cd', 1.34e-11],
		],
	...
	},
	{
		name: 'Cn-286',
		decayTypes: [
			['sf', 1], // a listed as secondary, no % given
			['a', trace],
		],
		halfLife: 8.4,
	},
